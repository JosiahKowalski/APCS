/**
 * Projects annual fuel usage based on three fill ups of my car.
 *
...
public class AnnualFuelUse {
	...
	// constructor
	AnnualFuelUse(int fill, int days, int sMiles, int eMiles, double gals, double price) {
		myFill = fill;
		myDays = days;
		myStartMiles = sMiles;
		myEndMiles = eMiles;
