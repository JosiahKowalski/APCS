...
public class CO2Footprint {
    ...
    private double myGasUsed, myElectricityBill, myElectricityPrice, myCO2GasTons, myCO2Gas, myCO2Electricity,
            myCO2Waste, myReductionWaste, myReductionBulbs, myCO2Footprint;
    private int myIndex, myPeople, myBulbsReplaced;
    private boolean myPaper, myPlastic, myGlass, myCans;
	public Object getMyReductionBulbs;
     ...
     */
    public CO2Footprint(int index, double gas, double avgBill, double avgPrice, int people, boolean paper, boolean plastic,
    ...
    public void calcBulbReduction() {
        myReductionBulbs = myBulbsReplaced * 100.01;
    }
    ...
    /**
     * Getter method to return myIndex
     * 
     * @return entry number
     */
    public double getMyIndex() {
        return myIndex;
    }
