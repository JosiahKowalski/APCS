...
public class CO2FootprintREF {
     ...
     */
    public CO2FootprintREF(double gas, double avgBill, double avgPrice, int people, boolean paper, boolean plastic,
     ...
     */
    public void calcCO2FootprintREF() {
        myCO2FootprintREF = (myCO2Gas + myCO2Electricity + myCO2Waste) - (myReductionWaste + myReductionBulbs);
    }
    ...
    /**
     * Getter method to return myCO2FootprintREF
     *
     * @return pounds of CO2
     */
    public double getMyCO2FootprintREF() {
        return myCO2FootprintREF;
    }
}
