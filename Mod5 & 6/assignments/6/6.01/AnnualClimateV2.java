/**
 * Displays average temperature and annual precipitation for the selected city, and
...
public class AnnualClimateV2
{
    ...
    public static void main (String [ ] args)
    {
        ...
        System.out.print("Choose the precipitation scale (in = inches, cm = centimeteres): ");
        ...
        if(precipChoice.equalsIgnoreCase("cm"))
        {
            precipLabel="cm.";
        ...
        System.out.printf("***************************************************%n");
        System.out.printf("%5sAverage Temp: %-8.1f Annual Prec: %.1f\n", "", average, annual);
